...
\begin{description}
    \item[a)]\- 
    	\verb|----a| The compiler sees two decrement prefix operators. The prefix operator immediately changes the value of a instead of returning a temporary value, hence it is ok to apply multiple prefex operators.
    \item[b)]\- 
